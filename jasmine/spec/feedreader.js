...
$(function () {
    ...
    describe('RSS Feeds', function () {
         ...
         */
        it('every feed should have a url', function () {
         ...
         */
        it('every feed should have a name', function () {
            for (feed of allFeeds) {
    ...
    describe('The Menu', function () {
         ...
         */
        it('Menu button behaves correctly', function () {
            let menuButton = $('.menu-icon-link')[0];
            // Click button
            menuButton.click();
